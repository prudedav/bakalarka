...
\midinsert \clabel[datasimulace]{Data použitá pro simulaci}
\ctable{lccccc}{ 
	\hfil Parametr & Hodnota & Označení & Poznámka  \crl
		...
		Výška satelitu  \cr
		Výška horní strany mostu &   \cr
		Výška dolní strany mostu &  \cr
		Vzdálenost horní hrany mostu &  \cr
		Vzdálenost dolní hrany mostu &  \cr
		Šířka mostu &  \cr
		Činitel odrazu vody   \cr
		Činitel odrazu koryta  \cr
		Frekvence   \cr
		Úhel odchylky stěny koryta   \cr
		Vzdálenost lodi od behu   \cr
		Počáteční intenzita elektrického pole   \cr
}
